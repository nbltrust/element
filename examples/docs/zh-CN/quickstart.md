...
```javascript
import Vue from 'vue';
import ElementUI from 'jp-element-ui';
import 'jp-element-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'jp-element-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'jp-element-ui';
