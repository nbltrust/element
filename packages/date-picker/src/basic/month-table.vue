...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'jp-element-ui/src/utils/date-util';
  import { hasClass } from 'jp-element-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'jp-element-ui/src/utils/util';
