...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'jp-element-ui/src/utils/date-util';
  import ElScrollbar from 'jp-element-ui/packages/scrollbar';
  import RepeatClick from 'jp-element-ui/src/directives/repeat-click';
